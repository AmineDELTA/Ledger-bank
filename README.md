...
> ℹ️ **Note on Multi-Cloud Topology & Cold Starts:**  
> This live deployment connects four decoupled cloud tiers over secure public internet TLS boundaries (Netlify Edge ⇄ Render Web Service ⇄ Upstash Redis ⇄ Neon PostgreSQL). On free-tier tiers, instances sleep after periods of inactivity. Initial requests may experience a 30–60 second cold-start delay while services spin up. Subsequent transactions process in real time.
